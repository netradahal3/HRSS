      ...
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php">
            <img src="assets/images/logo.png" alt="image"/><br><b>HOUSE RENTAL SYSTEM</b></a>
           </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="netradahal3@gmail.com">netradahal3@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service contact  Us: </p>
              <a href="tel:61-1234-5678-09">+977 9842526642</a> </div>
...
echo "Welcome House Rental System";
 } ?>
          </div>
        </div>
      </div>
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="house-listing.php">House/Room Listing</a>
